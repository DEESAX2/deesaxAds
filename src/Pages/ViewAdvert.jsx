...
export default function ViewAdvert() {
  ...
  return (
    <section>
      <Navbar />
      <div className="min-h-screen bg-gray-700 font-sans">
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8 mt-10">
            <div className="flex flex-col-reverse md:flex-row md:space-x-10 items-center md:items-start justify-center mb-10 md:mb-12 m-50">
              <div className="space-y-4 text-center md:text-left flex-1 min-w-0 md:pr-4">
                ...
                <p className="text-xl sm:text-2xl font-bold text-orange-700">Sarah Ocloo</p>
                <p className="text-sm sm:text-base text-gray-700 font-semibold">
                  Self-driven and passionate
                </p>
                <h4 className="text-3xl text-orange-950 font-semibold">The client's satisfaction is my priority</h4>

                <p className="text-2xl font-bold text-black pt-4">Email Address</p>
                <p className="text-white">client@needassistance@gmail.com</p>
                <br />
                <p className="text-2xl font-bold text-black">Phone Number</p>
