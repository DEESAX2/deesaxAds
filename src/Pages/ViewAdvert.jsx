...
export default function ViewAdvert() {
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      <Navbar />
      <div className="
              relative h-56 sm:h-64 md:h-80 lg:h-96 bg-cover bg-center bg-no-repeat flex items-center justify-center text-white shadow-md">
        <div>
          {/* <img src={yourBackgroundImage} alt="backgroundimage" /> */}
        </div><div className="absolute inset-0 bg-black opacity-20"></div>
      </div>
      <div className="container mx-auto px-4 sm:px-6 md:px-8 mt-10">
        ...
        <div className="flex flex-col justify-center items-center mt-10 sm:mt-12 mb-10 px-4">
          <label className="block bg-orange-200 text-gray-700 text-xl font-semibold px-4 py-2 rounded-md mb-6 shadow-sm">Leave Us A Message</label>
          <textarea
            placeholder="Enter message"
            rows="6"
            className="w-full max-w-2xl p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-500 text-gray-800 resize-y shadow-sm"
          ></textarea>
          <button className="mt-6 bg-orange-900 hover:bg-orange-300 text-white font-bold py-3 px-8 rounded-md shadow-lg transition duration-300 ease-in-out w-full max-w-2xl">
            Send Message
          </button>
        </div>
      </div>
