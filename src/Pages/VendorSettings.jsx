...
export default function VendorSettings() {
    return (
        <>
            <div className="flex">
                <VendorSideBar />
                <div className="min-h-screen flex-1 bg-gradient-to-br from-gray-100 via-blue-50 to-gray-200 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-6 text-gray-800 dark:text-gray-100">
                        ...
                        <section className="mb-10">
                            ...
                            <div className="flex items-center gap-6">
                                <img
                                    ...
                                    alt="Profile"
                                    className="w-24 h-24 rounded-full object-cover border-4 border-blue-200 dark:border-blue-700 shadow"
                                />
                                <div>
                                    <label
                                    ...
                                    <input
                                        ...
                                        name="profilePhoto"
                                        accept="image/*"
                                        className="block w-full text-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-blue-900 dark:file:text-blue-200"
                                    />
                                </div>
                            </div>
                        </section>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            name="firstName"
                                            required
                                            className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-400 dark:bg-gray-700 transition"
